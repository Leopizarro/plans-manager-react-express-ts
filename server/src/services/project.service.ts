...
export const createProject = async (projectInformation: ProjectRequest) => {
  ...
  if (projectInformation?.projectCategories?.length) {
    projectToInsert.projectCategories = await getProjectCategoriesFromString(
      projectInformation.projectCategories
    );
  }
...
const getProjectCategoriesFromString = async (
  projectCategoriesString: string
...
export const updateProject = async (
  ...
  try {
    ...
    projectFromDb.projectCategories = await getProjectCategoriesFromString(
      projectToUpdate.projectCategories
    );
